...
Excellent, the distinction is more clear now. That is, when I ask, "what is the
purpose", then we'll both understand that I'm seeking for the emergent _reason_
(_what for_), not _how come_.

I encourage you to read the whole book for a better understanding, but for our
purposes, acknowledging the ambiguous use of _why_, or _purpose_, is key
takeaway.

> [Tangent] >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

Interestingly, this distinction may help explain _how come_ the childlike
tendency to repeatedly ask "why?" can be annoying. My speculation involves two
major components:

1.) "Why?" is a lazy question&mdash;it implicitly forces the respondent to
disambiguate between _how come_ and _what for_.

2.) Often, we don't have good reasons. Generally, _how come_ is the better
question to answer, but both knowing _how come_, and how to explain _how come_,
requires a strong theory of mind and understanding of the subject.
...
foster curiosity, instead of stifling it.

> <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

So, it should now be clear that I'm asking a reason, that is, "_what_ is the
reason _for_ conversation?"

I'm not asking _how come_ we engage in conversation.

- Yes, maybe it's about simply a means of information transfer and exchange.
- Yes, maybe it's due to our evolutionary history, wherein selection forces help
  shaped our species into having a coordination superpower, and a desire to
  converse is an essential aspect to this superpower.
- And/or maybe it's because of a massive list of interacting causes.

I'm not asking about those causes. Again, I'm asking:
...
Alright! Let's dive in. We're finally ready to tackle the question and elaborate
on my conjecture... Well, we are almost ready.

The next essential import comes from Peter Boghossian and James A. Lindsay, in
...
Note: this list is certainly non-exhaustive. Additionally, it's a list of
discrete and functional reasons. There are probably many other reasons, and
plenty of times when it feels like there is no reason.

Crucially, it's this observation, that is, "at times it feels like there is no
reason" that I have wrestled with for a long time. Is this observation true? Or
am I failing to understand a potentially hidden reason?

What is the reason "just talk and connect" really describing? Is that not still
a discrete, functional reason? Does "just hanging out" count as nothing, or is
there still an emergent purpose involved?
...
again, together. Are those all conversations with, _no reason_?
...
just overanalyzing it? Maybe taking this concept too literally can actually hurt
a conversation?

Potentially true; this uncertainty is in large part why I'm making this video,
to explore such counterpoints.
...
difficulties that people have when talking can be often traced to a singular
...
motivation to either align the parties, or discover information about the
parties involved.
...
- **Reaching a mutual understanding** &rarr; &asymp; **4**: this involves
  discovering and understanding the other party, but also about aligning both
  parties around a shared understanding.
- **Learning from each other** &rarr; &asymp; **6**: this is more about
  discovery, but still involves understanding some aspect of the other party and
  aligning around that fact.
...
- **Intervening** &rarr; &asymp; **-7**: this is pretty close to a focus of pure
  alignment, as generally it involves redirection towards one of the party's
  desired position. However, it can be used a means for discovery, if the one
  explicitly desires the other party to change their beliefs in order to
...
- **Impressing** &rarr; &asymp; **-10**: this result assumes that the impressing
  ...
  conversations. Regardless, impressing is often entirely done to selectively
  reveal information to the other party in order to align the other with
  themselves in some way (e.g., getting them to like you).
- **Yielding to coercion** &rarr; &asymp; **0**: very neutral; either it's not
  ...
  - or an authority (or a party with more situational power) is threatening the
    ...
    discover how to stop the threat.
...
I don't at least attempt to make way to quantify the "reason for
a conversation."
...
a theoretical sense), would involve taking two large groups of people selected
at random from diverse populations and cultures.
...
- If certain types of conversations are hard to categorize, or map to the
  ...
  does not fit, or doesn't exist at all. Maybe these would be examples where
  conversation itself _is the purpose_?
- Or, both the control and the experimental groups would predictably struggle
  with similar odd situations, potentially indicating that the framing of what
  _the purpose_ was poorly communicated or heavy-handed.
...
meaning is derived from for the majority of people.
...
hurt), and you have instantaneous feedback if you're doing well, and doing well
...
a little too far into the poorly replicated pop psychology realm. However, the
point is, the _flow state_, or aspects of it, seem like an essential component
to making something meaningful.
...
Bringing it back to my revelation: I've learned that I may derive immense meaning
...
- A light conversation would have a rather neutral measure, wherein the parties
  ...
  to get into anything deeper (the elevator), or perhaps one side is fishing way
  to dive deeper via use of simple questions that allow for alignment around
  shared virtues that may to serve as a sturdy foundation.

- Alternatively, a heavy conversation would have a very weighted purpose, like
  an interview (or interrogation), where one party is primarily discovering, and
...
- Others conversations, like flirting, would be meaningful, but still light and
  ...
  hiding and revealing your intentions in a fun dance; trying too hard to align
  or too hard to discover is would ruin the game.

- And what about the collective rehashing of stories among friends? Perhaps the
  hardest to give a reason for initially, but now should be obvious. The
  _purpose_ seems to clearly be to continually align a group around a shared
  narrative. Each story is an instance of the group recounting the story,
...
the probability of having better and more enjoyable conversations.

I bet that if more people took the time to realize _what_ the purpose of
a conversation was _for_, then we'd start having conversations that mattered
more often; that bring us closer instead of dividing us; that serve to repair
historical misgivings, discover wondrous stories, new ideas, and alternative
points of view; that help grow and strengthen communities, governance, and
coordination.

Bold claims, I know. I suspect there are more questions bubbling to the surface
to back up these claims, and I hope to discuss them! I do intend to expand on
this idea by showing how better utilize the information gained when you reflect
upon where you might be at on the measure between alignment and discovery for
